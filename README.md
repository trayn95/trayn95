...
1. Тестировал web-сайт своего одногруппника ввиде дипломной работы
2. Тестировал и тестирую discord бота своего сервера (я заказчик и тестировщик)
3. Нашёл 4 бага локализации в vk.com (оформил баг репорты в vk testers)
4. Прохожу бесплатные курсы по тестированию
